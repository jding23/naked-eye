...
% params:
% points3D: Entire point cloud.
% layer_cross_Key_points: Key points corresponding to the slice, which can locate the position of the slice and thus find the points within the slice.
% theta0 - theta1: Screen rotation angle, basic parameter.
...
for x = 1:size(point_change, 1)
    ...
    elseif point_x < layer_cross_point_4(1) - 1  &  ((point_z > layer_cross_point_5(3))&(point_z < layer_cross_point_6(3)))
