...
% params:
% Color_matrix: A color grid of the same size as the screen grid, corresponding to the screen pixel display color.
% pixel_idx : Pixel position for coloring.
% colorRGB: color,the value is RGB channel 0-255.
% radius: The radius for filling color around a single target pixel. This can be used when the point cloud is sparse.
% fill_way: The specific method of filling, including methods 'Square' and 'Round'.
